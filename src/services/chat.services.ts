...
import { IChatMessage, IChatRoom, IChatUser,  IUserStatusesInChat } from '@/types/chat.types';
 ...
 * @returns {Promise<{ roomId: string; userId: number; status: 'added' }>} The updated chat room object.
 */
